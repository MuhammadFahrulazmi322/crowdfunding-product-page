...
function Product({openModal}) {
  ...
  return (
    <section className=" relative -top-14 bg-white rounded-lg  lg:px-40">
      <div className="flex flex-col justify-center items-center gap-5 lg:gap-10 px-2 relative -top-7">
        ...
        <div className="flex gap-2 items-center lg:justify-between justify-center w-full">
          ...
          <div className="flex gap-4 items-center">
            ...
            <p className={`
            ${bookmark ? "text-dark-gray" : "text-dark-cyan"} text-lg max-lg:hidden lg:block font-bold
      ...
      <div
        className="flex flex-col lg:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 xl:gap-[20%] lg:gap-[15%] mt-10"
      >
      ...
      <div className="relative mt-10 w-10/12 lg:w-full flex  lg:justify-start">
